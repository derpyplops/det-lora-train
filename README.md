...
1. **Same-machine bit-equality is achievable**, including under bf16 mixed precision and 10× longer training (500 steps). The standard determinism flags (below) are sufficient.
